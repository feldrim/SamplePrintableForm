...
namespace SamplePrintableForm.Controllers
{
    public class OffersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CustomerId,Date,Price,Currency")] Offer offer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CustomerId,Date,Price,Currency")] Offer offer)
        {
            if (id != offer.Id)
            {
                return NotFound();
